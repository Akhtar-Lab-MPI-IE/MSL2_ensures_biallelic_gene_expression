...
# Write out data
## DMLs
write.csv(kobs_dmls, '../Rout/ko_svjvscast_dmls.csv', quote=F)
write.csv(wtbs_dmls, '../Rout/wt_svjvscast_dmls.csv', quote=F)
## DMRs
write.csv(kobs_dmrs, '../Rout/ko_svjvscast_dmrs.csv', quote=F)
write.csv(wtbs_dmrs, '../Rout/wt_svjvscast_dmrs.csv', quote=F)
...
write.csv(CastKOvsWT_dmls, '../Rout/CastKOvsWT_dmls.csv', quote=F)
write.csv(CastKOvsWT_dmrs, '../Rout/CastKOvsWT_dmrs.csv', quote=F)
...
write.csv(SvjKOvsWT_dmls, '../Rout/SvjKOvsWT_dmls.csv', quote=F)
write.csv(SvjKOvsWT_dmrs, '../Rout/SvjKOvsWT_dmrs.csv', quote=F)
...
# Write out data
## DMLs
write.csv(KOvsWT_dmls, '../Rout/KOvsWT_full_dmls.csv', quote=F)
## DMRs
write.csv(KOvsWT_dmrs, '../Rout/KOvsWT_full_dmrs.csv', quote=F)
