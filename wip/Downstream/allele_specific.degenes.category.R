##Expression level comparison between WT and KO for Genome1 and 2 (Boxplot and heatmap)
############Usage################
# upperdir=/data/akhtar/Mouse2019AlleleSpecific/
# module load R/4.0.3  
# for dir in NPCs9sCa2019 NPCsCaBl2019 NPCsBlCa2019 ESCs9sCa2019 ESCsBlCa2019 ESCsCaBl2019
# do cd ${upperdir}/${dir}IntegrativeAnalysis && SlurmEasy -t 10 -n DEgenes.number.statistics "Rscript ~/scripts/allele_specific.degenes.category.R ${upperdir}/${dir}RNAseqMouse ${upperdir}/${dir}IntegrativeAnalysis DESeq2_sampleInfo.control.MSL2KO 0.05"
# done
#################################
...
prewd = args[1] #"/data/akhtar/Mouse2019AlleleSpecific/NPCs9sCa2019RNAseqMouse"
output.dir= args[2] #"/data/akhtar/Mouse2019AlleleSpecific/NPCs9sCa2019IntegrativeAnalysis"
deseq2.directory = args[3] #"DESeq2_sampleInfo.control.MSL2KO"
# prewd = "/data/akhtar/Mouse2019AlleleSpecific/NPCs9sCa2019RNAseqMouse"
# output.dir= "/data/akhtar/Mouse2019AlleleSpecific/NPCs9sCa2019IntegrativeAnalysis"
# fastq.prewd = "/data/akhtar/Mouse2019AlleleSpecific/Fastq/NPCs9sCa2019RNAseqMouse"
# deseq2.directory = "DESeq2_sampleInfo.control.MSL2KO"
# delete.chr = NA
# prewd = "/data/akhtar/Mouse2019AlleleSpecific/NPCsCaBl2019RNAseqMouse"
# output.dir= "/data/akhtar/Mouse2019AlleleSpecific/NPCsCaBl2019IntegrativeAnalysis"
# fastq.prewd = "/data/akhtar/Mouse2019AlleleSpecific/Fastq/NPCsCaBl2019RNAseqMouse"
# deseq2.directory = "DESeq2_sampleInfo.control.MSL2KO"
# delete.chr = NA
...
#########################################################################################################
####make bed file for Basic and Allelic UP and DOWN genes################
#########################################################################################################
...
#########################################################################################################
####make a table contain normalized count, my foldchange calculation and DEseq2 results################
#########################################################################################################
if(TRUE){
...
if(TRUE){
  ...
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.quantile.forth = counts.allelic.mean.log2FC.degenes.bi.genome1.biased  %>% filter( KOAll_genome2_log2FC < -(log2foldchange) & KO1_genome2 < expression.cutoff & KO2_genome2 < expression.cutoff )
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1 = counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1[counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1[,"padj"] <= logfc1.fdr,]
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1.extend = counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1[counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1[,pvaluecol] <= fdr,]
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.up = counts.allelic.mean.log2FC.degenes.bi.genome1.biased[apply(counts.allelic.mean.log2FC.degenes.bi.genome1.biased[,grep("KOAll_genome1_log2FC",colnames(counts.allelic.mean.log2FC.degenes.bi.genome1.biased)),drop=FALSE],1,function(x){all(x>0)}),] ##G1 is up regulated, optional
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.down = counts.allelic.mean.log2FC.degenes.bi.genome1.biased[apply(counts.allelic.mean.log2FC.degenes.bi.genome1.biased[,grep("KOAll_genome1_log2FC",colnames(counts.allelic.mean.log2FC.degenes.bi.genome1.biased)),drop=FALSE],1,function(x){any(x<=0)}),] ##G1 is down regulated, optional
  # dim(counts.allelic.mean.log2FC.degenes.bi.genome1.biased %>% filter(KOAll_genome2_log2FC > 0 & AllelicComparison_log2FC > 1 ) )
  ...
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.quantile.forth = counts.allelic.mean.log2FC.degenes.bi.genome2.biased  %>% filter( KOAll_genome1_log2FC < -(log2foldchange) & KO1_genome1 < expression.cutoff & KO2_genome1 < expression.cutoff )
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1 = counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1[counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1[,"padj"] <= logfc1.fdr,]
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1.extend = counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1[counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1[,pvaluecol] <= fdr,]
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.up = counts.allelic.mean.log2FC.degenes.bi.genome2.biased[apply(counts.allelic.mean.log2FC.degenes.bi.genome2.biased[,grep("KOAll_genome2_log2FC",colnames(counts.allelic.mean.log2FC.degenes.bi.genome2.biased)),drop=FALSE],1,function(x){all(x>0)}),] ##G2 is up regulated, optional
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.down = counts.allelic.mean.log2FC.degenes.bi.genome2.biased[apply(counts.allelic.mean.log2FC.degenes.bi.genome2.biased[,grep("KOAll_genome2_log2FC",colnames(counts.allelic.mean.log2FC.degenes.bi.genome2.biased)),drop=FALSE],1,function(x){any(x<=0)}),] ##G2 is down regulated, optional
  # dim(counts.allelic.mean.log2FC.degenes.bi.genome2.biased %>% filter(KOAll_genome2_log2FC > 0 & AllelicComparison_log2FC < -1 ) )
  ...
  # counts.allelic.mean.log2FC.degenes.mono.genome1.biased.logfc1 = counts.allelic.mean.log2FC.degenes.mono.genome1.biased.logfc1[counts.allelic.mean.log2FC.degenes.mono.genome1.biased.logfc1[,"KOAll_genome1_pvalue"] <= pvalue.cutoff,] #G1 is down regulated
  #dim(counts.allelic.mean.log2FC.degenes.mono.genome1.biased %>% filter(KOAll_genome2_log2FC > 1 & KO1_genome2 > 10))
  ...
  # counts.allelic.mean.log2FC.degenes.mono.genome2.biased.logfc1 = counts.allelic.mean.log2FC.degenes.mono.genome2.biased.logfc1[counts.allelic.mean.log2FC.degenes.mono.genome2.biased.logfc1[,"KOAll_genome2_pvalue"] <= pvalue.cutoff,] #G1 is down regulated
  #dim(counts.allelic.mean.log2FC.degenes.mono.genome2.biased %>% filter(KOAll_genome1_log2FC > 1 & KO1_genome1 > 10))
  ...
  # counts.allelic.mean.log2FC.degenes.bi.both.down.logfc0.5 = counts.allelic.mean.log2FC.degenes.bi.both.down %>%  filter(KOAll_genome1_log2FC <= -(log2foldchange.small) & KOAll_genome2_log2FC <= -(log2foldchange.small) )
  # counts.allelic.mean.log2FC.degenes.bi.both.down.logfc1 = counts.allelic.mean.log2FC.degenes.bi.both.down %>%  filter(KOAll_genome1_log2FC <= -(log2foldchange) & KOAll_genome2_log2FC <= -(log2foldchange))
  ...
  # counts.allelic.mean.log2FC.degenes.bi.both.down.quantile.third = counts.allelic.mean.log2FC.degenes.bi.both.down %>% filter((KOAll_genome1_log2FC <= -(log2foldchange) & KOAll_genome1_log2FC > -(log2foldchange.big)) | (KOAll_genome2_log2FC <= -(log2foldchange) & KOAll_genome2_log2FC > -(log2foldchange.big)) )
  # counts.allelic.mean.log2FC.degenes.bi.both.down.logfc1 = counts.allelic.mean.log2FC.degenes.bi.both.down.logfc1 %>% filter(KO1_genome1 <= (expression.cutoff) & KO1_genome2 <= (expression.cutoff) & KO2_genome1 <= (expression.cutoff) & KO2_genome2 <= (expression.cutoff) )
  
  # counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1 = counts.allelic.mean.log2FC.degenes.bi.genome1.biased.quantile.forth
  # counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1 = counts.allelic.mean.log2FC.degenes.bi.genome2.biased.quantile.forth
  # counts.allelic.mean.log2FC.degenes.mono.genome1.biased.logfc1 = counts.allelic.mean.log2FC.degenes.mono.genome1.biased.quantile.forth
  # counts.allelic.mean.log2FC.degenes.mono.genome2.biased.logfc1 = counts.allelic.mean.log2FC.degenes.mono.genome2.biased.quantile.forth
  # counts.allelic.mean.log2FC.degenes.bi.both.down.logfc1 = counts.allelic.mean.log2FC.degenes.bi.both.down.quantile.forth
  ...
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.mono.order)],con=file.path(output.dir,"DE.allelic.mono.all.biased.bed"))
  ...
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome1.biased.logfc1.extend)],con=file.path(output.dir,"DE.allelic.bi.genome1.biased.logfc1.extend.bed"))
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome1.biased.up)],con=file.path(output.dir,"DE.allelic.bi.genome1.biased.up.bed"))
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome1.biased.down)],con=file.path(output.dir,"DE.allelic.bi.genome1.biased.down.bed"))
  ...
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome2.biased.logfc1.extend)],con=file.path(output.dir,"DE.allelic.bi.genome2.biased.logfc1.extend.bed"))
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome2.biased.up)],con=file.path(output.dir,"DE.allelic.bi.genome2.biased.up.bed"))
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.genome2.biased.down)],con=file.path(output.dir,"DE.allelic.bi.genome2.biased.down.bed"))
  ...
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.degenes.bi.order)],con=file.path(output.dir,"DE.allelic.bi.all.biased.bed"))
  ...
  # export(species.database.anno.gene.granges[rownames(counts.allelic.mean.log2FC.combined.degenes.all)],con=file.path(output.dir,"DE.allelic.all.degenes.bed"))
  ...
  gene.mono.g2.biased = mono.allelic.genes[mono.allelic.genes$Status=="UP",]
